...
### Create datasource
curl -H "$JSONHEADER" -d '{"name":"TDengine","type":"taosdata-tdengine-datasource","typeLogoUrl":"","access":"proxy","url":"http://taos:6041","password":"","user":"","database":"","basicAuth":false,"basicAuthUser":"","basicAuthPassword":"","withCredentials":false,"isDefault":true,"jsonData":{"user":"root","password":"taosdata"},"secureJsonFields":{},"version":1,"readOnly":false}' $GRAFANA/datasources || { echo "Error: fail to create grafana data source, will retry";}
### Create report
